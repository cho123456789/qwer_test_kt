...
> 
> 번거롭게 앱을 켜지 않아도, 스마트폰을 켜는 그 짧은 찰나에 **QWER의 에너지**를 마주할 수 있다면 어떨까요? 최애의 모습을 단지 데이터로 저장하는 것이 아니라, **Android 홈 화면**이라는 가장 가까운 공간에 생동감 있게 배치하고자 하는 진심에서 이 프로젝트가 시작되었습니다.
