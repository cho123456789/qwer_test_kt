...
앱 내에서 콘셉트 버튼을 누르면 컨셉 에맞는 랜덤으로 이미지가 추출됩니다.
...
마음에 드는 사진을 찾았다면? 단 한 번의 터치로 홈 화면과 잠금 화면을 동시에 바꿀 수 있습니다.



2. 나만의 커스텀 위젯

다양한 모드: 기본 사진 위젯은 물론, 디데이(D-Day)와 시계 위젯까지 지원합니다.
자유로운 커스텀: 사진 위에 올라가는 글자의 크기, 색상, 위치를 내 마음대로 조절해 나만의 위젯 완성해 보세요
...
* **🗂️ Data Expansion (데이터베이스 고도화)**
  ...
  * 약 420장의 사진 업데이트 실시 완료 (12/26) + 30장 (1/11) 
...
* **🎁 Community Release (팬덤 공유 및 배포)**
  ...
  * 현재 배포 완료 (1/12 ~ ) <br> https://cafe.naver.com/f-e/cafes/30157532/articles/456235?boardtype=L&menuid=68&referrerAllArticles=false&page=2
---


## ⚖️ 10. License & Copyright
