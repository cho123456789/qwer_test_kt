...
class MySecondProvider : AppWidgetProvider() {
    ...
    private fun updateAllWidgets(context: Context) {
        ...
        val componentName = ComponentName(context, MySecondProvider::class.java)
    ...
    fun scheduleNextUpdate(context: Context) {
        val intent = Intent(context, MySecondProvider::class.java).apply {
