...
class ChodanWidgetProvider : AppWidgetProvider() {
    ...
    private fun updateAllWidgets(context: Context) {
        ...
        val componentName = ComponentName(context, ChodanWidgetProvider::class.java)
        ...
        for (id in widgetIds) {
            ...
            val views = RemoteViews(context.packageName, R.layout.chodan_widget)
    ...
    fun scheduleNextUpdate(context: Context) {
        val intent = Intent(context, ChodanWidgetProvider::class.java).apply {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.S) {
            if (alarmManager.canScheduleExactAlarms()) {
                ...
                Log.d("ChodanWidget", "Scheduled exact alarm")
            } else {
                ...
                Log.d("ChodanWidget", "Scheduled inexact alarm (no exact alarm permission)")
            }
        } else {
            ...
            Log.d("ChodanWidget", "Scheduled exact alarm (Android < 12)")
        }
    }
