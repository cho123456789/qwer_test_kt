...
class MythirdProvider : AppWidgetProvider() {
    ...
    private fun updateAllWidgets(context: Context) {
        ...
        val componentName = ComponentName(context, MythirdProvider::class.java)
        ...
        for (id in widgetIds) {
            ...
            val views = RemoteViews(context.packageName, R.layout.thrid_widget)
    ...
    fun scheduleNextUpdate(context: Context) {
        val intent = Intent(context, MythirdProvider::class.java).apply {
